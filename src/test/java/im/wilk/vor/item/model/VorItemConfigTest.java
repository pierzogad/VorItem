...
class VorItemConfigTest {
    ...
    public void whenCreated_AllItemsAreSet() {
        ...
        VorItemConfig config = new VorItemConfig(parserConfig, LENIENT_STRUCTURE_SET, LENIENT_LISTS_UNSET);
        ...
        config = new VorItemConfig(parserConfig, LENIENT_STRUCTURE_UNSET, LENIENT_LISTS_SET);
