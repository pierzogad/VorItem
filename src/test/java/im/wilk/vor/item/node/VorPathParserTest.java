...
class VorPathParserTest {
    ...
    public void givenNewIndex_ItIsModified() {
        VorPathParser pathParser = new VorPathParser(PathParserConfig.pathWithDotAndBrackets());
    ...
    public void givenDifferentConfigs_TheyAreInterChangeable() {
        ...
        VorPathParser sqlParser = new VorPathParser(PathParserConfig.pathWithDotAndBrackets());
        VorPathParser fileParser = new VorPathParser(PathParserConfig.pathWithSlashAndColon());
